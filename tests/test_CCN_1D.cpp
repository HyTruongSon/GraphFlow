...
// To compile: g++ -std=c++11 -pthread test_CCN_1D.cpp
...
const double nChanels_decay = 0.5;
...
string model_fn = "CCN_1D-model.dat";

CCN_1D train_network(max_nVertices, max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nFeatures, nChanels_decay);
CCN_1D test_network(max_nVertices, max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nFeatures, nChanels_decay);
