...
string model_fn = "SMP_2D_ver8-model.dat";

SMP_2D_ver8 train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_2D_ver8 test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
