...
string model_fn = "SMP_1D_ver2-model.dat";

SMP_1D_ver2 train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_1D_ver2 test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
