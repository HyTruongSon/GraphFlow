...
string model_fn = "Unrestricted_SMP_1D_ver2-model.dat";

Unrestricted_SMP_1D_ver2 train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
Unrestricted_SMP_1D_ver2 test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
