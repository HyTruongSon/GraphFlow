...
string model_fn = "GCN_3D_Distance-model.dat";

GCN_3D_Distance train_network(nLevels, max_nVertices, nFeatures, nHiddens, nDepth, max_Radius, momentum_param);
GCN_3D_Distance test_network(nLevels, max_nVertices, nFeatures, nHiddens, nDepth, max_Radius, momentum_param);
