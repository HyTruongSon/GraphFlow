...
string model_fn = "Unrestricted_SMP_1D-model.dat";

Unrestricted_SMP_1D train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
Unrestricted_SMP_1D test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
...
int main(int argc, char **argv) {
	...
	for (int i = 0; i < nMolecules; ++i) {
		...
		vector<double> feature = test_network.ForDebugging(molecule[i] -> graph);
	}
	*/
