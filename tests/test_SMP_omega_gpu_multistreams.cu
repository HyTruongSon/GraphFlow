...
#include "../GraphFlow_gpu_32bit/SMP_omega_gpu_multistreams.h"
...
string model_fn = "SMP_omega_gpu_multistreams-model.dat";

SMP_omega_gpu_multistreams train_network(max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nDepth);
SMP_omega_gpu_multistreams test_network(max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nDepth);
