...
string model_fn = "CGCN_1D-model.dat";

CGCN_1D train_network(nLevels, max_nVertices, nFeatures, nDepth, momentum_param);
CGCN_1D test_network(nLevels, max_nVertices, nFeatures, nDepth, momentum_param);
