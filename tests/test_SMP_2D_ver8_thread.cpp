...
// To compile: g++ -std=c++11 -pthread test_SMP_2D_ver8_thread.cpp
...
const int nEpochs = 200;

const int nMolecules = 4;

string model_fn = "SMP_2D_ver8_thread-model.dat";

SMP_2D_ver8_thread train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_2D_ver8_thread test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
