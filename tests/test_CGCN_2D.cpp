...
string model_fn = "CGCN_2D-model.dat";

CGCN_2D train_network(nLevels, max_nVertices, nFeatures, nDepth, momentum_param);
CGCN_2D test_network(nLevels, max_nVertices, nFeatures, nDepth, momentum_param);
