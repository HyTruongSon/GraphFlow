...
const int nContractions = RisiContraction_4_thread::nContractions;
...
int main(int argc, char **argv) {
	RisiContraction_4_thread *obj = new RisiContraction_4_thread(N, nChanels);
	...
	// Similuation for RisiContraction_6_thread
	obj -> clear();
	for (int i = 0; i < N; ++i) {
