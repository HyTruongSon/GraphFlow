...
string model_fn = "SMP_2D_ver6-model.dat";

SMP_2D_ver6 train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_2D_ver6 test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
