...
string model_fn = "SMP_2D_ver5-model.dat";

SMP_2D_ver5 train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_2D_ver5 test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
