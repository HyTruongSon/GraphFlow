...
string model_fn = "SMP_2D_ver3-model.dat";

SMP_2D_ver3 train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_2D_ver3 test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
