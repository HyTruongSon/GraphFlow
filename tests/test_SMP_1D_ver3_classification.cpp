...
string model_fn = "SMP_1D_ver3_classification-model.dat";

SMP_1D_ver3_classification train_network(nClass, max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_1D_ver3_classification test_network(nClass, max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
