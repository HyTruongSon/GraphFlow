...
string model_fn = "Unrestricted_SMP_2D-model.dat";

Unrestricted_SMP_2D train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
Unrestricted_SMP_2D test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
