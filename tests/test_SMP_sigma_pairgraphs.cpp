...
string model_fn = "SMP_sigma_pairgraphs-model.dat";

SMP_sigma_pairgraphs train_network(max_nVertices, max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nFeatures, nKept);
SMP_sigma_pairgraphs test_network(max_nVertices, max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nFeatures, nKept);
