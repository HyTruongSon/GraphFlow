...
string model_fn = "SMP_2D_ver4_classification-model.dat";

SMP_2D_ver4_classification train_network(nClass, max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_2D_ver4_classification test_network(nClass, max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
