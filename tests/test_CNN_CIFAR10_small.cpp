...
const string model_fn = "CNN_CIFAR10_small.model";
const string report_fn = "CNN_CIFAR10_small.report";
...
void network_architecture() {
	...
	// Convolution layer 1
	filter1 = new Tensor4D(5, 5, input -> nDepth, 16);
	...
	// Convolution layer 2
	filter2 = new Tensor4D(5, 5, pool1 -> nDepth, 20);
	...
	// Convolution layer 3
	filter3 = new Tensor4D(5, 5, pool2 -> nDepth, 20);
