...
// To compile: g++ -std=c++11 -pthread test_SMP_beta_physics.cpp
...
string model_fn = "SMP_beta_physics-model.dat";

SMP_beta_physics train_network(max_nVertices, nLevels, nChanels, nFeatures);
SMP_beta_physics test_network(max_nVertices, nLevels, nChanels, nFeatures);
