...
#include "../GraphFlow_gpu_32bit/SMP_beta_gpu.h"
...
string model_fn = "SMP_beta_gpu-model.dat";

SMP_beta_gpu train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth);
SMP_beta_gpu test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth);
