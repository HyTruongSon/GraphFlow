...
const string model_fn = "model-LSTM.dat";

int nLevels;

LSTM *train_network = new LSTM(nFeatures, nHiddens, nClasses, max_nLevels, momentum_param);
LSTM *test_network = new LSTM(nFeatures, nHiddens, nClasses, max_nLevels, momentum_param);
