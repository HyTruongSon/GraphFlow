...
#include "../GraphFlow_32bit/SMP_beta.h"
...
SMP_beta train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth);
SMP_beta test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth);
