...
string model_fn = "SMP_2D-model.dat";

SMP_2D train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_2D test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
