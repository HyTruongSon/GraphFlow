...
string model_fn = "GCN_MW-model.dat";

GCN_MW train_network(nLevels, max_nVertices, nFeatures, nHiddens, nDepth, momentum_param);
GCN_MW test_network(nLevels, max_nVertices, nFeatures, nHiddens, nDepth, momentum_param);
