...
// To compile: g++ -std=c++11 -pthread test_SMP_beta_pairgraphs.cpp
...
string model_fn = "SMP_beta_pairgraphs-model.dat";

SMP_beta_pairgraphs train_network(max_nVertices, max_nVertices, nLevels, nChanels, nFeatures, nFeatures);
SMP_beta_pairgraphs test_network(max_nVertices, max_nVertices, nLevels, nChanels, nFeatures, nFeatures);
