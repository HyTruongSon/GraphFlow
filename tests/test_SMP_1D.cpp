...
string model_fn = "SMP_1D-model.dat";

SMP_1D train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_1D test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
