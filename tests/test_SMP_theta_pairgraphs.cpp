...
string model_fn = "SMP_theta_pairgraphs-model.dat";

SMP_theta_pairgraphs train_network(max_nVertices, max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nFeatures);
SMP_theta_pairgraphs test_network(max_nVertices, max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nFeatures);
