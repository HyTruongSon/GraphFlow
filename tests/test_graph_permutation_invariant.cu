...
const int max_receptive_field = 20;
const int nChanels = 10;
const int nLevels = 6;
const int nFeatures = 6;
const int nDepth = 5;

SMP_omega_gpu network(nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nDepth, false);
...
int main(int argc, char **argv) {
	...
	vector<float> graph_feature_1 = network.Feature(graph1);
	...
	vector<float> graph_feature_2 = network.Feature(graph2);
