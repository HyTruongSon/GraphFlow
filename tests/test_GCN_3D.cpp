...
string model_fn = "GCN_3D-model.dat";

GCN_3D train_network(nLevels, max_nVertices, nFeatures, nHiddens, nDepth, max_Radius, momentum_param);
GCN_3D test_network(nLevels, max_nVertices, nFeatures, nHiddens, nDepth, max_Radius, momentum_param);
