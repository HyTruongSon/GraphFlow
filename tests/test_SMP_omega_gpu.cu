...
string model_fn = "SMP_omega_gpu-model.dat";

SMP_omega_gpu train_network(max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nDepth);
SMP_omega_gpu test_network(max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nDepth);
