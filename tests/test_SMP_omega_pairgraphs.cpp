...
string model_fn = "SMP_omega_pairgraphs-model.dat";

SMP_omega_pairgraphs train_network(max_nVertices, max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nFeatures);
SMP_omega_pairgraphs test_network(max_nVertices, max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures, nFeatures);
