...
string model_fn = "SMP_2D_ver7-model.dat";

SMP_2D_ver7 train_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
SMP_2D_ver7 test_network(max_nVertices, nLevels, nChanels, nFeatures, nDepth, momentum_param);
