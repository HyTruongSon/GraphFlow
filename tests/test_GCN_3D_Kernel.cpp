...
string model_fn = "GCN_3D_Kernel-model.dat";

GCN_3D_Kernel train_network(nLevels, max_nVertices, nFeatures, nHiddens, nDepth, max_Radius, momentum_param);
GCN_3D_Kernel test_network(nLevels, max_nVertices, nFeatures, nHiddens, nDepth, max_Radius, momentum_param);
