...
// To compile: g++ -std=c++11 -pthread test_SMP_gamma_physics.cpp
...
string model_fn = "SMP_gamma_physics-model.dat";

SMP_gamma_physics train_network(max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures);
SMP_gamma_physics test_network(max_nVertices, max_receptive_field, nLevels, nChanels, nFeatures);
