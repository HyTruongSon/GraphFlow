...
const string model_fn = "model_CNN_MNIST_averagepool.dat";
...
void network_architecture() {
	...
	// Pooling layer 1
	pool1 = new AveragePool2D(conv1_reshape, 2, 2);
	...
	// Pooling layer 2
	pool2 = new AveragePool2D(conv2_reshape, 2, 2);
