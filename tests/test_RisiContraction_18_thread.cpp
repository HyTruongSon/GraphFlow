...
const int nContractions = RisiContraction_18_thread::nContractions;
...
int main(int argc, char **argv) {
	RisiContraction_18_thread *obj = new RisiContraction_18_thread(N, nChanels);
	...
	// Similuation for RisiContraction_18_thread
	obj -> clear();
	for (int i = 0; i < N; ++i) {
