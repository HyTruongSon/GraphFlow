...
public:
	...
	static void compute_gradient_job(SMP_theta *instance, DenseGraph *molecule, float target) {
	...
	static void predict_job(SMP_theta *instance, DenseGraph *molecule, float *predict, int position) {
		instance -> complete_computation_graph(molecule);
		instance -> graph -> forward();
