...
#ifndef __GCN_2D_H_INCLUDED__
#define __GCN_2D_H_INCLUDED__
...
class GCN_2D {
public:
	GCN_2D(int nLevels, int max_nVertices, int nFeatures, int nHiddens, int nDepth, int max_Radius, double momentum_param) {
