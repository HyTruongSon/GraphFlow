...
public:
	...
	static void compute_gradient_job(SMP_omega_gpu_multistreams *instance, cudaStream_t stream, DenseGraph *molecule, double target) {
	...
	static void predict_job(SMP_omega_gpu_multistreams *instance, cudaStream_t stream, DenseGraph *molecule, double *predict, int position) {
		instance -> complete_computation_graph(molecule);
