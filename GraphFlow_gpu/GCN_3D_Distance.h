...
#ifndef __GCN_3D_DISTANCE_H_INCLUDED__
#define __GCN_3D_DISTANCE_H_INCLUDED__
...
class GCN_3D_Distance {
public:
	GCN_3D_Distance(int nLevels, int max_nVertices, int nFeatures, int nHiddens, int nDepth, int max_Radius, double momentum_param) {
	...
	void computation_graph() {
		...
		for (int l = 0; l <= nLevels; ++l) {
			...
			if (l == 0) {
				...
				chanel_vertex[l] -> neighbor = new RisiLayer3D* [max_nVertices];
				chanel_vertex[l] -> pooling = new KMax* [max_nVertices];
				...
				for (int v = 0; v < max_nVertices; ++v) {
					...
					chanel_vertex[l] -> neighbor[v] = new RisiLayer3D(nHiddens);
					chanel_vertex[l] -> pooling[v] = new KMax(chanel_vertex[l] -> neighbor[v], nHiddens);
					chanel_vertex[l] -> part2[v] = new MatVecMul(chanel_vertex[l] -> W2, chanel_vertex[l] -> pooling[v]);
		...
		for (int l = 0; l <= nLevels; ++l) {
			...
			if (l == 0) {
				...
				chanel_distance[l] -> neighbor = new RisiLayer3D* [max_nVertices];
				chanel_distance[l] -> pooling = new KMax* [max_nVertices];
				...
				for (int v = 0; v < max_nVertices; ++v) {
					...
					chanel_distance[l] -> neighbor[v] = new RisiLayer3D(nHiddens);
					chanel_distance[l] -> pooling[v] = new KMax(chanel_distance[l] -> neighbor[v], nHiddens);
					chanel_distance[l] -> part2[v] = new MatVecMul(chanel_distance[l] -> W2, chanel_distance[l] -> pooling[v]);
		...
		for (int l = 0; l <= nLevels; ++l) {
			...
			if (l == 0) {
				...
				for (int v = 0; v < molecule -> nVertices; ++v) {
					...
					graph -> add(chanel_vertex[l] -> neighbor[v], RISILAYER3D);
					graph -> add(chanel_vertex[l] -> pooling[v], KMAX);
		...
		for (int l = 0; l <= nLevels; ++l) {
			...
			if (l == 0) {
				...
				for (int v = 0; v < molecule -> nVertices; ++v) {
					...
					graph -> add(chanel_distance[l] -> neighbor[v], RISILAYER3D);
					graph -> add(chanel_distance[l] -> pooling[v], KMAX);
	...
	~GCN_3D_Distance() {
		for (int l = 0; l <= nLevels; ++l) {
			...
			delete[] chanel_vertex[l] -> pooling;
			...
			delete[] chanel_distance[l] -> pooling;
