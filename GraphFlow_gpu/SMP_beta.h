...
public:
	...
	static void compute_gradient_job(SMP_beta *instance, DenseGraph *molecule, double target) {
	...
	static void predict_job(SMP_beta *instance, DenseGraph *molecule, double *predict, int position) {
		instance -> complete_computation_graph(molecule);
		instance -> graph -> forward();
