...
#ifndef __GCN_1D_H_INCLUDED__
#define __GCN_1D_H_INCLUDED__
...
class GCN_1D {
public:
	GCN_1D(int nLevels, int max_nVertices, int nFeatures, int nHiddens, int nDepth, int max_Radius, double momentum_param) {
