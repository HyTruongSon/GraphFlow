// Framework: GraphFlow
// Class: Covariant Graph Convolution Networks (Second-order representation)
// Author: Machine Learning Group of UChicago
// Institution: Department of Computer Science, The University of Chicago
// Copyright 2017 (c) UChicago. All rights reserved.

#ifndef __CGCN_2D_H_INCLUDED__
#define __CGCN_2D_H_INCLUDED__
...
class CGCN_2D {
public:
	CGCN_2D(int nLevels, int max_nVertices, int nFeatures, int nDepth, double momentum_param) {
	...
	void computation_graph() {
		...
		for (int l = 0; l <= nLevels; ++l) {
			...
			if (l == 0) {
				...
				for (int v = 0; v < max_nVertices; ++v) {
					level[l] -> neighbor[v] = new RisiLayer2D(max_nVertices);
