...
public:
	SMP_2D_ver6_classification(int nClass, int max_nVertices, int nLevels, int nChanels, int nFeatures, int nDepth, float momentum_param) {
		this -> nClass = nClass;
	...
	SMP_2D_ver6_classification(int nClass, int max_nVertices, int nLevels, int nChanels, int nFeatures, int nDepth, float momentum_param, bool has_WL_ordering) {
		this -> nClass = nClass;
		this -> max_nVertices = max_nVertices;
		this -> nLevels = nLevels;
		this -> nChanels = nChanels;
