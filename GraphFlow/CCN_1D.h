...
class CCN_1D {
public:
	CCN_1D(int max_nVertices_1, int max_nVertices_2, int max_receptive_field, int nLevels, int nChanels, int nFeatures_1, int nFeatures_2, double nChanels_decay) {
	...
	static void predict_job(CCN_1D *instance, DenseGraph *molecule_1, DenseGraph *molecule_2, double *predict, int position) {
