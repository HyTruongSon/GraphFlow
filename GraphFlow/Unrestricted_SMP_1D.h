// Framework: GraphFlow
// Class: First-order Unrestricted Steerable Message Passing
// Author: Machine Learning Group of UChicago
// Institution: Department of Computer Science, The University of Chicago
// Copyright 2017 (c) UChicago. All rights reserved.

#ifndef __Unrestricted_SMP_1D_H_INCLUDED__
#define __Unrestricted_SMP_1D_H_INCLUDED__
...
class Unrestricted_SMP_1D {
public:
	Unrestricted_SMP_1D(int max_nVertices, int nLevels, int nChanels, int nFeatures, int nDepth, double momentum_param) {
	...
	Unrestricted_SMP_1D(int max_nVertices, int nLevels, int nChanels, int nFeatures, int nDepth, double momentum_param, bool has_WL_ordering) {
		this -> max_nVertices = max_nVertices;
		this -> nLevels = nLevels;
		this -> nChanels = nChanels;
		this -> nFeatures = nFeatures;
