// Framework: GraphFlow
// Class: Second-order Steerable Message Passing (Omega version + Pair graphs)
// Author: Machine Learning Group of UChicago
// Institution: Department of Computer Science, The University of Chicago
// Copyright 2017 (c) UChicago. All rights reserved.

#ifndef __SMP_OMEGA_PAIRGRAPHS_H_INCLUDED__
#define __SMP_OMEGA_PAIRGRAPHS_H_INCLUDED__
...
public:
	...
	SMP_omega_pairgraphs(int max_nVertices_1, int max_nVertices_2, int max_receptive_field, int nLevels, int nChanels, int nFeatures_1, int nFeatures_2) {
	...
	SMP_omega_pairgraphs(bool use_coulomb, int max_nVertices_1, int max_nVertices_2, int max_receptive_field, int nLevels, int nChanels, int nFeatures_1, int nFeatures_2) {
		assert(max_receptive_field <= max_nVertices_1);
		assert(max_receptive_field <= max_nVertices_2);
	...
	void init_multi_threads(int nThreads) {
		...
		instance = new SMP_omega_pairgraphs* [this -> nThreads];
		for (int i = 0; i < nThreads; ++i) {
			instance[i] = new SMP_omega_pairgraphs(use_coulomb, max_nVertices_1, max_nVertices_2, max_receptive_field, nLevels, nChanels, nFeatures_1, nFeatures_2);
		}
	...
	void computation_graph_(
		...
		SMP_omega_pairgraphs::Level **level, Matrix **feature, ShrinkTensor ***shrinked, LeakyReLU ***vertex_feature, SumVectors **level_feature,
	...
	void init_receptive_field_permutation_matrix_reduced_adj(DenseGraph *molecule, SMP_omega_pairgraphs::Level **level, int **shortest_paths, int **adj) {
	...
	void complete_computation_graph_(DenseGraph *molecule, SMP_omega_pairgraphs::Level **level, Matrix *H, Matrix **feature, int **shortest_paths, 
	...
	static void compute_gradient_job(SMP_omega_pairgraphs *instance, 
	...
	static void predict_job(SMP_omega_pairgraphs *instance, DenseGraph *molecule_1, DenseGraph *molecule_2, double *predict, int position) {
