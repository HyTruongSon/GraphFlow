// Framework: GraphFlow
// Class: First-order Steerable Message Passing Classification
// Author: Machine Learning Group of UChicago
// Institution: Department of Computer Science, The University of Chicago
// Copyright 2017 (c) UChicago. All rights reserved.

#ifndef __SMP_1D_classification_H_INCLUDED__
#define __SMP_1D_classification_H_INCLUDED__
...
class SMP_1D_classification {
public:
	SMP_1D_classification(int nClass, int max_nVertices, int nLevels, int nChanels, int nFeatures, int nDepth, double momentum_param) {
		this -> nClass = nClass;
	...
	SMP_1D_classification(int nClass, int max_nVertices, int nLevels, int nChanels, int nFeatures, int nDepth, double momentum_param, bool has_WL_ordering) {
		this -> nClass = nClass;
		this -> max_nVertices = max_nVertices;
		this -> nLevels = nLevels;
		this -> nChanels = nChanels;
